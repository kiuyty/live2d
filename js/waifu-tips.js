(() => {
  ...
  function D(e, o, t) {
    if (
      ...
      (sessionStorage.getItem("waifu-text") &&
        sessionStorage.getItem("waifu-text") > t)
    )
      return;
  ...
  var U = {
      ...
      "switch-model": { icon: S, callback: () => {} },
      "switch-texture": { icon: x, callback: () => {} },
      info: {
        icon: b,
        callback: () => {
        ...
        for (let i of e.tools)
          if (u[i]) {
            ...
            (document
              ...
              .insertAdjacentHTML(
                "beforeend",
                `<span id="waifu-tool-${i}">${l}</span>`,
              ),
              document
                .getElementById(`waifu-tool-${i}`)
      ...
      (window.addEventListener("mousemove", () => (i = !0)),
        ...
        s.seasons.forEach(({ date: w, text: d }) => {
          ...
          f.split("/")[0] <= n.getMonth() + 1 &&
            ...
            f.split("/")[1] <= n.getDate() &&
            n.getDate() <= r.split("/")[1] &&
            ((d = g(d)), (d = d.replace("{year}", n.getFullYear())), m.push(d));
        }));
      let h = () => {};
      (console.log("%c", h),
        (h.toString = () => {
      ...
      ((window.onmousemove = function (f) {
        if (l) {
          if (n || e.dragDirection.includes("x")) {
            ...
            (r < 0
              ? (r = 0)
              : r > window.innerWidth - i.clientWidth &&
                (r = window.innerWidth - i.clientWidth),
              (s.style.left = r + "px"));
          }
          if (n || e.dragDirection.includes("y")) {
            ...
            (r < 30
              ? (r = 30)
              : r > window.innerHeight - i.clientHeight + 10 &&
                (r = window.innerHeight - i.clientHeight + 10),
              (s.style.top = r + "px"));
          }
        }
  ...
  function B(e, o) {
    ...
    (t.addEventListener("click", () => {
      (t.classList.remove("waifu-toggle-active"),
        t.getAttribute("first-time")
          ? (E(e), t.removeAttribute("first-time"))
          : (localStorage.removeItem("waifu-display"),
  ...
  function H() {
    ...
    if (document.referrer !== "") {
      ...
      return location.hostname === t.hostname
        ? e
        : (c in s ? (o = s[c]) : (o = t.hostname),
          `Hello\uFF01\u6765\u81EA <span>${o}</span> \u7684\u670B\u53CB<br>${e}`);
    }
    return e;
  }
  function z() {
